...
// Save Context (ram start: 0x00587958). The named fields below are read-only
// inputs to the replacement HUD; the remaining layout stays opaque.
typedef struct {
