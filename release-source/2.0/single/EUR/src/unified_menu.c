...
#if UNIFIED_MENU_PROTOTYPE && (defined(Version_USA) || defined(Version_EUR))
...
void UnifiedMenu_DrawBackdrop(void) {
    ...
    if (!node) {
        ...
        node=((void*(*)(void*,void*,void*,u32))0x0034897C)
...
static void DrawFooterBrackets(u32 focus) {
    ...
    if (!sFocusNodes[index]) {
        ...
        ((void(*)(void*,u32,void*,u32,u32,u32,u32))0x00348A64)
            (resource,0,texture,0x2601,0x2601,0x812f,0x812f);
        sFocusNodes[index]=((void*(*)(void*,void*,void*,u32))0x0034897C)
            (*(void**)0x005C0A34,resource,0,0);
...
static void DrawFooter(void) {
    ...
    if (!sFooterNodes[focus]) {
        ...
        ((void(*)(void*,u32,void*,u32,u32,u32,u32))0x00348A64)
            (resource,0,texture,0x2601,0x2601,0x812f,0x812f);
        sFooterNodes[focus]=((void*(*)(void*,void*,void*,u32))0x0034897C)
            (*(void**)0x005C0A34,resource,0,0);
...
static void* CreateHeader(u32 active) {
    ...
    /* The replacement Items sprite includes a bottom stone frame, unlike
     * the open-bottom Gear/Map tabs. Stop inside its blue inset so the shared
     * content divider is the only lower edge. Both focus states use this crop. */
    ...
    ((void(*)(void*,u32,void*,u32,u32,u32,u32))0x00348A64)
        (resource,0,texture,0x2601,0x2601,0x812f,0x812f);
    void* node=((void*(*)(void*,void*,void*,u32))0x0034897C)
        (*(void**)0x005C0A34,resource,0,0);
    if (node) *(u32*)((u8*)node+0x178)|=2;
    return node;
}
...
static void DrawShelfFrame(void) {
    ...
    if (!nodes[gear]) {
        ...
        nodes[gear]=((void*(*)(void*,void*,void*,u32))0x0034897C)
...
void UnifiedMenu_PrepareDungeonMaterials(void) {
    if (!InputRemap_IsItemsMenuOpen() || InputRemap_IsItemsPageActive() ||
        InputRemap_IsGearPageActive() || !((int (*)(void))0x002F1268)()) return;
...
void UnifiedMenu_DrawHeader(void) {
    ...
    for (u32 t = 0; t < 3; ++t) {
        ...
        /* Items now carries a complete frame in its replacement artwork.
         * Do not layer the old three-slice frame over that new bevel. */
        for (u32 q = frames[t]; t != 0 && q < frames[t]+3; ++q)
