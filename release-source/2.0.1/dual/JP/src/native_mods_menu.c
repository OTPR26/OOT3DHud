...
#define NATIVE_BOARD_POSITIONS ((NativeBoardBufferFn)ADDR(0x002FC3FC))
#define NATIVE_BOARD_UVS ((NativeBoardBufferFn)ADDR(0x002FC3F0))
#define NATIVE_BOARD_COLORS ((NativeBoardBufferFn)ADDR(0x002FC3E4))
